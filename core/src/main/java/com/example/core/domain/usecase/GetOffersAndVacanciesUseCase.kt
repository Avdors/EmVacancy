...
class GetOffersAndVacanciesUseCase(
    ...
    suspend fun execute(): Pair<List<OfferFeatureModel>, List<VacancyFeatureModel>> {
        ...
        var allOffers = mutableListOf<OfferFeatureModel>()
        var allVacancies = mutableListOf<VacancyFeatureModel>()
